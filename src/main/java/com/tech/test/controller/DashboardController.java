...
@Tag(name = "Dashboard Controller", description = "Dashboard endpoints for retrieving student dashboard information")
public class DashboardController {

    private final DashboardService service;

    @GetMapping("/{studentId}")
    @Operation(summary = "Get student dashboard", description = "Retrieve dashboard information for a specific student including tests, scores, and progress")
    @ApiResponses(value = {
