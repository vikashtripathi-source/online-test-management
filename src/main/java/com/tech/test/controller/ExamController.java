...
public class ExamController {
    ...
    @Operation(summary = "Add multiple questions", description = "Add multiple questions to the question bank in a single request")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get all questions", description = "Retrieve all questions from the question bank")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Delete a question", description = "Delete a question from the question bank by ID")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Submit test", description = "Submit a test for immediate evaluation and get results")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Test submitted and evaluated successfully"),
    ...
    @Operation(summary = "Submit test asynchronously", description = "Submit a test for asynchronous evaluation via Kafka messaging")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "202", description = "Test submission accepted and queued for evaluation"),
        @ApiResponse(responseCode = "400", description = "Invalid test submission data"),
        @ApiResponse(responseCode = "500", description = "Internal server error")
    })
    ...
    @Operation(summary = "Save student test record", description = "Save a new student test record to the database")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Student test record successfully created"),
    ...
    @Operation(summary = "Update student test record", description = "Update an existing student test record by ID")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Student test record successfully updated"),
        @ApiResponse(responseCode = "400", description = "Invalid student record data"),
    ...
    @Operation(summary = "Delete student test record", description = "Delete a student test record by ID")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "204", description = "Student test record successfully deleted"),
        @ApiResponse(responseCode = "404", description = "Student record not found"),
        @ApiResponse(responseCode = "500", description = "Internal server error")
    })
    ...
    @Operation(summary = "Get student records by branch", description = "Retrieve all student test records for a specific branch")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully retrieved student records"),
    ...
    public ResponseEntity<List<StudentTestRecordDTO>> getRecordsByBranch(
            @Parameter(description = "Branch to filter student records") @PathVariable Branch branch) {
        return ResponseEntity.ok(service.getRecordsByBranch(branch));
    }

    @GetMapping("/questions/branch/{branch}")
    @Operation(summary = "Get questions by branch", description = "Retrieve all questions for a specific branch")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully retrieved questions"),
        @ApiResponse(responseCode = "400", description = "Invalid branch parameter"),
        @ApiResponse(responseCode = "500", description = "Internal server error")
    ...
    @Operation(summary = "Get test results", description = "Retrieve test results for a specific student")
    @ApiResponses(value = {
