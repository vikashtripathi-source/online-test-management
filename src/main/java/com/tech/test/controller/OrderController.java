...
public class OrderController {
    ...
    public ResponseEntity<List<OrderDTO>> getOrdersByStudent(@PathVariable Long studentId) {

        return ResponseEntity.ok(orderService.getOrdersByStudent(studentId));
    }

    @GetMapping("/student/{studentId}/addresses")
    public ResponseEntity<List<AddressDTO>> getByStudent(@PathVariable Long studentId) {
