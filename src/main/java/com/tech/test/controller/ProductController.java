...
@Tag(name = "Product Management API", description = "Operations related to Product management and catalog")
public class ProductController {

    private final ProductService service;

    @PostMapping
    @Operation(summary = "Create Product", description = "Create a new product with the provided product details")
    @ApiResponses(value = {
    ...
    @GetMapping
    @Operation(summary = "Get All Products", description = "Retrieve all products from the product catalog")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get Products By Branch", description = "Retrieve all products associated with a specific branch")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully retrieved products by branch"),
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Delete Product", description = "Delete a product from the system by its ID")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get Inventory Status", description = "Retrieve inventory status of all products including stock levels")
    @ApiResponses(value = {
    ...
    @PutMapping("/{id}/stock")
    @Operation(summary = "Update Stock Quantity", description = "Update the stock quantity for a specific product")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Stock quantity successfully updated"),
    ...
    @Operation(summary = "Increase Stock", description = "Increase stock quantity for a specific product")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Decrease Stock", description = "Decrease stock quantity for a specific product")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get Branch Inventory", description = "Retrieve inventory status for products in a specific branch")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully retrieved branch inventory"),
        @ApiResponse(responseCode = "400", description = "Invalid branch parameter"),
        @ApiResponse(responseCode = "500", description = "Internal server error")
    })
