...
@Tag(name = "Student Management", description = "APIs for managing student operations including image upload")
public class StudentController {
    ...
    @Operation(summary = "Public test endpoint", description = "Test endpoint that doesn't require authentication")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Register a new student", description = "Create a new student account with the provided details")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Student login", description = "Authenticate student credentials and return JWT token")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Upload student image", description = "Upload a profile image for a student (max 2MB)")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get student image", description = "Retrieve the profile image of a student")
    @ApiResponses(value = {
