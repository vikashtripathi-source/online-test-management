...
public class KafkaConsumerService {
    ...
    public KafkaConsumerService(QuestionRepository questionRepo, StudentAnswerRepository answerRepo) {
    ...
    private void updateInventory(Order order) {
        System.out.println("Inventory updated for: " + order.getProductName());
    }
}
