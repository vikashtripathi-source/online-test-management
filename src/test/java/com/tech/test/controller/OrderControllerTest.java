...
public class OrderControllerTest {
    ...
    void testGetAllOrders() throws Exception {
        ...
        OrderDTO order1 = new OrderDTO(1L, "Product A", 5, "123 Main St", "City", "12345");

        OrderDTO order2 = new OrderDTO(2L, "Product B", 3, "456 Elm St", "Town", "67890");
    ...
    void testGetOrderById() throws Exception {
        ...
        OrderDTO order = new OrderDTO(1L, "Product A", 5, "123 Main St", "City", "12345");
    ...
    void testSubmitOrderWithAddress() throws Exception {
        ...
        OrderDTO submittedOrder = new OrderDTO(1L, "Product A", 5, "123 Main St", "City", "12345");
